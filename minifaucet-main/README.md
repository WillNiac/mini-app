...
- 📺 **Ads Settings**:
  ...
  - **Adextra**: Enable/disable, Publisher ID
...
ADEXTRA_PUBLISHER_ID=your_adextra_publisher_id
...
1. Register at [Adextra](https://adextra.io)
2. Get your Publisher ID
3. Enable Adextra in Admin Settings
4. Enter the Publisher ID
